package com.sapt.suoan.common.util.iputils;
...
public class IPSeeker {
	...
	// 开发环境文件位置
	private static final String IP_FILE = "D:/suoanupload/qqwry.dat";
	// 测试环境以及客户正式环境文件位置
	// private static final String IP_FILE = "/opt/apache-tomcat-8.0.8/webapps/suoanupload/qqwry.dat";
